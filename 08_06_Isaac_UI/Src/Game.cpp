...
extern int bullet_damage = 5;
extern float p_Attack_Speed = 0.3f;
...
int Game::Start()
{
	...
	windowHeight = DXUTGetD3D9BackBufferSurfaceDesc()->Height;
	windowWidth = DXUTGetD3D9BackBufferSurfaceDesc()->Width;
