                                     ...
                                     void* pUserContext )
{
	...
	g_pEnemyBullets = new EnemyBullet[50];

	for (int i = 0; i < 25; i++)
	{
		int a = rand() % 1024;
		int b = rand() % 2;
		g_pEnemyBullets[i].position = D3DXVECTOR2(a, b * 768);
		//g_pEnemyBullets[i].Start();
	}
	...
	for (int i = 25; i < 50; i++)
	{
		int a = rand() % 2;
		int b = rand() % 768;
		g_pEnemyBullets[i].position = D3DXVECTOR2(a * 1024, b);
		//g_pEnemyBullets[i].Start();
	}

	g_ObjectManager.Start();
...
void CALLBACK OnFrameMove( double fTime, float fElapsedTime, void* pUserContext )
{
	...
	g_ObjectManager.Update(fElapsedTime);
}
